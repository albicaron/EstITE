...
PEHE_Train = cbind(read.csv("./IHDP/Results/IHDP_1000_CATT_Train_PEHE.csv"), 
                   read.csv("./IHDP/Results/GP_1000_CATT_Train_PEHE.csv"))
PEHE_Test = cbind(read.csv("./IHDP/Results/IHDP_1000_CATT_Test_PEHE.csv"), 
                  read.csv("./IHDP/Results/GP_1000_CATT_Test_PEHE.csv"))
...
joy_train <-
  ...
  scale_x_continuous(limits = c(0, 4), breaks = seq(0, 4, 1)) + xlab(expression(sqrt(PEHE))) +
...
# Save joy plots
ggsave(filename = "./IHDP/Figures/IHDP_Joy_Train.pdf", plot = joy_train, 
       width = 14, height = 12, units = "cm")

ggsave(filename = "./IHDP/Figures/IHDP_Joy_Test.pdf", plot = joy_test, 
       width = 14, height = 12, units = "cm")
